// ============================================================================
// File: ascon_permutation_d2.v
// Description: Masked Ascon Permutation for Order D = 2 (4 shares)
//              Executes 'rounds' (12 or 6) iterations of (p_C -> p_S -> p_L)
//              over 4 shared 320-bit states.
// ============================================================================

`timescale 1ns / 1ps

module ascon_permutation_d2 (
    input  wire         clk,
    input  wire         reset,
    input  wire [4:0]   ctr,
    input  wire [319:0] S_0, S_1, S_2, S_3,
    input  wire [4:0]   rounds,
    input  wire         start,
    input  wire [63:0]  r0, r1, r2, r3, r4, r5, r6, r7, // Fresh randomness

    output wire [319:0] out_0, out_1, out_2, out_3,
    output wire         done
);

    // State registers for 4 shares (5 x 64-bit words each)
    ...
    reg [63:0] x0_3_q, x1_3_q, x2_3_q, x3_3_q, x4_3_q;
    ...
    wire [63:0] x0_3_d, x1_3_d, x2_3_d, x3_3_d, x4_3_d;
    ...
    always @(posedge clk) begin
        if (reset) begin
            ...
            {x0_3_q, x1_3_q, x2_3_q, x3_3_q, x4_3_q} <= 320'd0;
            done_reg <= 1'b0;
        end else begin
            if (start) begin
                if (ctr == 5'd0) begin
                    ...
                    {x0_3_q, x1_3_q, x2_3_q, x3_3_q, x4_3_q} <= S_3;
                end else begin
                    ...
                    {x0_3_q, x1_3_q, x2_3_q, x3_3_q, x4_3_q} <= {x0_3_d, x1_3_d, x2_3_d, x3_3_d, x4_3_d};
                end
            end
    ...
    assign out_3 = {x0_3_q, x1_3_q, x2_3_q, x3_3_q, x4_3_q};

    // 1. Constant Addition (p_C)
    wire [63:0] rc_out_0, rc_out_1, rc_out_2, rc_out_3;
    wire [3:0]  current_round_idx = (ctr > 5'd0) ? (ctr[3:0] - 4'd1) : 4'd0;

    ascon_roundconstant_d2 u_rc_d2 (
        .x2_0_in(x2_0_q), .x2_1_in(x2_1_q), .x2_2_in(x2_2_q), .x2_3_in(x2_3_q),
        .r0(r5), .r1(r6), .r2(r7),
        .round_idx(current_round_idx),
        .total_rounds(rounds),
        .x2_0_out(rc_out_0), .x2_1_out(rc_out_1), .x2_2_out(rc_out_2), .x2_3_out(rc_out_3)
    );
    ...
    wire [63:0] y0_3, y1_3, y2_3, y3_3, y4_3;
    ...
    ascon_sbox_d2 u_sbox_d2 (
        ...
        .x0_3(x0_3_q), .x1_3(x1_3_q), .x2_3(rc_out_3), .x3_3(x3_3_q), .x4_3(x4_3_q),
        ...
        .y0_3(y0_3), .y1_3(y1_3), .y2_3(y2_3), .y3_3(y3_3), .y4_3(y4_3)
    );

    // 3. Linear Diffusion Layer (p_L)
    ascon_linear_d2 u_lin_d2 (
        ...
        .in0_3(y0_3), .in1_3(y1_3), .in2_3(y2_3), .in3_3(y3_3), .in4_3(y4_3),
        ...
        .out0_3(x0_3_d), .out1_3(x1_3_d), .out2_3(x2_3_d), .out3_3(x3_3_d), .out4_3(x4_3_d)
    );
